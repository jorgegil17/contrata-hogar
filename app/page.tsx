  ...
  return <main className="shell">
    ...
    <section className="workspace" id="top">
      ...
      <div className="content">
        ...
        <div className="month">
          <article className={'pay ' + (paid ? 'done' : '')}><div className="cardtop"><b>€</b><span>{paid ? 'PAGADA' : payrollPrepared ? 'PENDIENTE DE PAGO' : 'SIN PREPARAR'}</span></div><p>Nómina de agosto</p><strong>{euro(net)}</strong><small>Neto estimado a transferir</small><div className="actions"><button className="primary" onClick={() => setActiveView('payroll')}>{paid ? 'Ver nómina' : 'Gestionar nómina'}</button><button disabled={!payrollPrepared} onClick={generateReceipt}>Recibo PDF</button></div></article>
